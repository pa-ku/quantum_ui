...
export default function Product_card() {
  const codeBlock = `<figure className="relative w-56 shadow-md shadow-gray-900">
  <div className="rounded-t-xl bg-white">
    <span
      aria-label="Descuento"
      className="absolute right-0 rounded-bl-xl rounded-tr-xl bg-primary px-3 textfont-bold">
      0%
    </span>
    <img
