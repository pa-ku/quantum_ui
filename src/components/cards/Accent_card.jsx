...
export default function Accent_card() {
  const codeBlock = `<div class="relative
    ...
    bg-gray-900 mix-blend-multiply">
    <p className="text-xl">Quantum</p>
    </div>

    <span class="-z-10 absolute h-80 w-80 animate-spin 
  ...
  return (
    <>
      <div className="relative flex h-60 w-40 items-center justify-center overflow-hidden rounded-xl p-0.5">
        <div className="flex h-full w-full items-center justify-center rounded-xl bg-gray-900 mix-blend-multiply">
          <svg
        ...
        <span className="absolute -z-10 h-80 w-80 rounded-full bg-gradient-to-r from-[#24c295] to-[#bd2eff] animate-rotate"></span>
      </div>
